        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20 max-w-6xl mx-auto w-full min-[450px]:p-20 sm:p-0">
          <div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <h1 className="text-lg font-semibold color-primary">Large Set</h1>
              </div>
            </div>
          </div>
          <div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <h1 className="text-lg font-semibold color-primary">Candle Set</h1>
              </div>
            </div>
          </div>
          <div>
          ...
          <div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <h1 className="text-lg font-semibold color-primary">Peonies</h1>
              </div>
            </div>
          </div>
        </div>
